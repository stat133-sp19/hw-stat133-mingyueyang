...
# private: these are auxiliary functions not intended to be called by the user
# main: these are the main functions that the user is expected to invoke
# methods: these are also public functions that support classes of objects generated by some of the main functions.
#
